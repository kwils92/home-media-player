...
class TicketsController extends AbstractController
{
    ...
    /**
     * @Route("/{idtickets}", name="tickets_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idtickets}/edit", name="tickets_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{idtickets}", name="tickets_delete", methods={"DELETE"})
     */
    public function delete(Request $request, Tickets $ticket): Response
    {
        if ($this->isCsrfTokenValid('delete'.$ticket->getIdtickets(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
